    ...
    if (this.cmsettings) {
      ...
      if (this.cmsettings.mode === 'dragging') {
        ...
        if (this.quizCMEo && this.selCMEo) {
          ...
          this.tempQuizCMEo.cmobject.style.object.trans = this.cmsettings.cmtbquizedit.trans;
          this.tempQuizCMEo.cmobject.style.object.color0 = this.cmsettings.cmtbquizedit.color0;
          this.tempQuizCMEo.cmobject.style.object.color1 = this.cmsettings.cmtbquizedit.color1;
        } else {
