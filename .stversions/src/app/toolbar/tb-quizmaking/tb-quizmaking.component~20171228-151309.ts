...
@Component({
  selector: 'app-tb-quizmaking',
  templateUrl: './tb-quizmaking.component.html',
  styleUrls: ['./tb-quizmaking.component.scss']
})
export class TbQuizmakingComponent implements OnInit {
